...
<body id="top">
					...
					<tbody>
						<c:forEach var="col" items="${Users}">
							<tr>
								...
								<td data-title="UserName">${col.userName}</td>
								<td data-title="Password">${col.password}</td>
						...
						<div class="modal-body">
							...
							<div class="form-inline">
								<label>User Name:</label> <input id="userName"
									class="form-control" autofocus name="userName" type="email" required />
							</div>
							<br>
							<div class="form-inline">
								<label>Password:</label> <input id="password"
									class="form-control" autofocus name="password" type="text" required/>
							</div>
						</div>
	...
	<script type="text/javascript">
		$(".edit").click(function() {
			...
			if(col1==1){
				alert("Edit/Delete option is disabled for this user");
			} else {
				$("#id").val(col1);
				$("#userName").val(col2);
				$("#password").val(col3);
